...
namespace ItemSearchPlugin
{
    public class GenericItem
    {
        ...
        public string Name
        {
            get
            {
                return itemType switch
                {
                    ...
                    ItemType.Item => item.Name.ExtractText()
                        .Replace("\u00AD", string.Empty), //Remove the SoftHyphens from FR/DE
                    _ => string.Empty
                };
            }
        }
        ...
        public static explicit operator Item(GenericItem genericItem) =>
            genericItem.itemType == ItemType.Item ? genericItem.item : default;

        public static explicit operator EventItem(GenericItem genericItem) =>
            genericItem.itemType == ItemType.EventItem ? genericItem.eventItem : default;
