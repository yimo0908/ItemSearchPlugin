...
namespace ItemSearchPlugin.Filters
{
    class LevelEquipSearchFilter : SearchFilter
    {
        ...
        public override string Name => "装备等级";
        ...
        {
            return item.LevelEquip >= (usingTag ? taggedMin : minLevel) &&
                   item.LevelEquip <= (usingTag ? taggedMax : maxLevel);
        }
        ...
        public override bool ParseTag(string tag)
        {
            ...
            var tags = new []
            {
                "level", "lvl", "elvl", "clvl", "elevel", "clevel", "characterlevel", "character level", "equip level",
                "equiplevel"
            };
